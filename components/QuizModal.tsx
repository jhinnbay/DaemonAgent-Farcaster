...
export default function QuizModal({ isOpen, onClose, survey, onComplete }: QuizModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="sticky top-0 p-6 border-b" style={{ background: 'rgba(18, 18, 26, 0.95)', borderColor: 'rgba(120, 138, 255, 0.2)' }}>
            ...
            {currentQuestion.options.map((option, index) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left p-4 transition-all hover:scale-[1.02]"
                  style={{
        ...
        {/* Footer Navigation */}
        <div className="sticky bottom-0 p-6 border-t" style={{ background: 'rgba(18, 18, 26, 0.95)', borderColor: 'rgba(120, 138, 255, 0.2)' }}>
