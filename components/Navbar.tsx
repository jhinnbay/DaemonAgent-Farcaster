    ...
    <>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `
              ...
              0 0 60px rgba(113, 119, 255, 0.08),
          ...
          <button
            ...
            style={{
              ...
              background: currentPage === 'profile'
                ? 'linear-gradient(135deg, rgba(113, 119, 255, 0.25) 0%, rgba(36, 115, 188, 0.2) 100%)'
                : hoveredItem === 'profile'
                  ? 'rgba(113, 119, 255, 0.1)'
                  : 'transparent',
              border: currentPage === 'profile'
                ? '1px solid rgba(113, 119, 255, 0.4)'
                : '1px solid transparent',
              transform: hoveredItem === 'profile' ? 'scale(1.08)' : 'scale(1)',
              boxShadow: currentPage === 'profile'
                ? '0 0 20px rgba(113, 119, 255, 0.3), inset 0 0 12px rgba(113, 119, 255, 0.1)'
                : 'none'
            }}
          >
            {/* Profile Icon */}
            <svg
              ...
              style={{
                ...
                filter: currentPage === 'profile' ? 'drop-shadow(0 0 8px rgba(113, 119, 255, 0.6))' : 'none',
            ...
            >
              <circle
                ...
                cy="8"
                r="4"
                stroke={currentPage === 'profile' ? '#7177FF' : '#ffffff'}
                strokeWidth="1.5"
                fill="none"
              />
              <path
          ...
          <button
            ...
            style={{
              ...
              background: currentPage === 'daemon'
                ? 'linear-gradient(135deg, rgba(221, 43, 46, 0.3) 0%, rgba(239, 47, 127, 0.25) 50%, rgba(113, 119, 255, 0.2) 100%)'
                : hoveredItem === 'daemon'
                  ? 'linear-gradient(135deg, rgba(221, 43, 46, 0.15) 0%, rgba(239, 47, 127, 0.1) 100%)'
                  : 'linear-gradient(135deg, rgba(221, 43, 46, 0.08) 0%, rgba(239, 47, 127, 0.05) 100%)',
              border: currentPage === 'daemon'
                ? '2px solid rgba(239, 47, 127, 0.5)'
                : '1px solid rgba(239, 47, 127, 0.2)',
              transform: hoveredItem === 'daemon' ? 'scale(1.1)' : 'scale(1)',
              boxShadow: currentPage === 'daemon'
                ? `
                    0 0 30px rgba(239, 47, 127, 0.4),
                    0 0 60px rgba(221, 43, 46, 0.2),
                    inset 0 0 20px rgba(239, 47, 127, 0.15)
                  `
                : hoveredItem === 'daemon'
                  ? '0 0 20px rgba(239, 47, 127, 0.25)'
                  : 'none',
          ...
          >
            ...
            <svg
              ...
              style={{
                filter: currentPage === 'daemon'
                  ? 'drop-shadow(0 0 12px rgba(239, 47, 127, 0.8))'
                  : hoveredItem === 'daemon'
                    ? 'drop-shadow(0 0 8px rgba(239, 47, 127, 0.5))'
                    : 'none',
                transition: 'all 0.3s ease-out',
            ...
            >
              <path
                ...
                fill={currentPage === 'daemon' ? '#EF2F7F' : hoveredItem === 'daemon' ? '#EF2F7F' : '#ffffff'}
              ...
              <path
                ...
                stroke={currentPage === 'daemon' ? '#EF2F7F' : hoveredItem === 'daemon' ? '#EF2F7F' : '#ffffff'}
                strokeWidth="3"
                fill="none"
            ...
            <span
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(221, 43, 46, 0.9) 0%, rgba(239, 47, 127, 0.9) 100%)',
                ...
                pointerEvents: 'none',
                boxShadow: '0 4px 12px rgba(239, 47, 127, 0.3)'
              }}
            >
              DAEMON
            </span>
          ...
          <button
            ...
            style={{
              ...
              background: currentPage === 'token'
                ? 'linear-gradient(135deg, rgba(36, 115, 188, 0.25) 0%, rgba(113, 119, 255, 0.2) 100%)'
                : hoveredItem === 'token'
                  ? 'rgba(36, 115, 188, 0.1)'
                  : 'transparent',
              border: currentPage === 'token'
                ? '1px solid rgba(36, 115, 188, 0.4)'
                : '1px solid transparent',
              transform: hoveredItem === 'token' ? 'scale(1.08)' : 'scale(1)',
              boxShadow: currentPage === 'token'
                ? '0 0 20px rgba(36, 115, 188, 0.3), inset 0 0 12px rgba(36, 115, 188, 0.1)'
                : 'none'
            }}
          >
            {/* Token/Coin Icon */}
            <svg
              ...
              style={{
                ...
                filter: currentPage === 'token' ? 'drop-shadow(0 0 8px rgba(36, 115, 188, 0.6))' : 'none',
                transition: 'all 0.3s ease-out'
              }}
            >
              {/* Outer ring */}
              <circle
                ...
                cy="12"
                r="9"
                stroke={currentPage === 'token' ? '#2473BC' : '#ffffff'}
                strokeWidth="1.5"
                fill="none"
              />
              ...
              <path
                ...
                fill={currentPage === 'token' ? '#2473BC' : '#ffffff'}
                style={{ opacity: 0.8 }}
              />
            </svg>
      ...
      <style jsx global>{`
        @keyframes pulse-glow {
          0%, 100% {
            filter: drop-shadow(0 0 12px rgba(239, 47, 127, 0.8));
          }
          50% {
            filter: drop-shadow(0 0 20px rgba(239, 47, 127, 1)) drop-shadow(0 0 40px rgba(221, 43, 46, 0.5));
          }
        }
      `}</style>
    </>
